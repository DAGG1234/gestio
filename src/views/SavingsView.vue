        ...
        <form @submit.prevent="handleCreateSaving" class="space-y-3.5">
          <div class="space-y-1">
            ...
            <input
              ...
              class="w-full px-3 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-xs font-bold text-slate-900 placeholder:text-slate-400 focus:outline-none focus:border-emerald-600"
              required
            />
          </div>
          ...
          <div class="grid grid-cols-2 gap-3">
            <div class="space-y-1">
              ...
              <select
                ...
                class="w-full px-3 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-xs font-bold text-slate-900 focus:outline-none focus:border-emerald-600"
              >
